...
public class Nhanvien implements Serializable {
	...
	public Nhanvien(String hovaTen, Boolean gioiTinh, Chucvu ChucVu, int sodienthoai, String email, Tinh queQuan,
			String MaNhanVien, float Luong) {
		super();
	...
	public String toString() {
		return "Nhanvien [MaNhanVien=" + MaNhanVien + ", HovaTen=" + HovaTen + ", Email=" + Email + ", ChucVu=" + ChucVu
				+ ", SoDienThoai=" + SoDienThoai + ", QueQuan=" + QueQuan + ", gioiTinh=" + gioiTinh + ", Luong="
				+ Luong + "]";
	}
